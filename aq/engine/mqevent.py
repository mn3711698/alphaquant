...
class EventServer:
    ...
    def connect(self):
        ...
        connection = pika.BlockingConnection(
            pika.ConnectionParameters(host=self._host, port=self._port, credentials=credentials,heartbeat=0))
        channel = connection.channel()
        self._connect=connection
        exchanges = ["Trade", "Ticker", "OrderBook", "Kline.15min", "Asset","Logger" ]
